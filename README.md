...
| `hoody-black.jpg`, `hoody-grey.jpg` | 후디 티저 섹션 사진. HTML 에 경로로 들어가 있어 배포 시 함께 올라갑니다. |
...
- 페이지 문구는 영어만 씁니다. 2026-09-13 에 한글 병기 줄과 한국어(ko) 로케일을 모두 걷어냈습니다. 시트로 넘어가는 동의 값만 `동의` 로 남아 있습니다(시트 머리글이 한글).
